...
def executar_relogio():
    ...
    socket_servidor.bind((host, 12348))
    ...
    outros_servidores = [(host, 12346), (host, 12347)]  # Adicione outros servidores conforme necessário
    ...
    def ajustar_relogio_com_base_na_latencia_e_maior_horario():
        ...
        while True:
            ...
            time.sleep(1)  # Ajusta a cada segundo
